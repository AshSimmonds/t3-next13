...
const EmptyPage: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Typography HTML (mostly)</title>
            </Head>
            ...
            <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3 md:flex-row">
                    <div className="md:w-1/2">
                        <div>
                            <input title='dummytitle' type="checkbox" className="toggle" checked />
                            <input title='dummytitle'
                                type="checkbox"
                        ...
                        <div>
                            <input title='dummytitle' type="checkbox" className="checkbox" checked />
                            <input title='dummytitle'
                                type="checkbox"
                        ...
                        <div>
                            <input title='dummytitle' type="radio" name="radio-1" className="radio" checked />
                            <input title='dummytitle'
                                type="radio"
                                name="radio-1"
                ...
                <div className="flex gap-3">
                    <div className="flex flex-grow flex-col gap-3">
                        <div className="text-4xl font-bold">Text Size 1<span className="badge">text-4xl</span></div>
                        <div className="text-3xl font-bold">Text Size 2 <span className="badge">text-3xl</span></div>
                        <div className="text-2xl font-bold">Text Size 3 <span className="badge">text-2xl</span></div>
                        <div className="text-xl font-bold">Text Size 4 <span className="badge">text-xl</span></div>
                        <div className="text-lg font-bold">Text Size 5 <span className="badge">text-lg</span></div>
                        <div className="text-sm font-bold">Text Size 6 <span className="badge">text-sm</span></div>
                        <div className="text-xs font-bold">Text Size 7 <span className="badge">text-xs</span></div>
                    </div>
            ...
            <div
                className="min-h-screen py-8 flex flex-col justify-center relative overflow-hidden lg:py-12"
            >
                <div
                    className="absolute inset-0 bg-[url(/img/grid.svg)] bg-top [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"
                >
                </div>
                <div
                    className="relative w-full px-6 py-12 bg-base-300 shadow-xl shadow-slate-700/10 ring-1 ring-gray-900/5 md:max-w-3xl md:mx-auto lg:max-w-4xl lg:pt-16 lg:pb-28"
                >
                    ...
                    <div className="mt-8 mx-auto lg:prose-lg">
                        <p className="lead">
                        ...
                        <pre><code className="language-js">module.exports = _
                            purge: [],
                            theme: _
                            extend: __,
                            variants: __,
